            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {fiturList.map((fitur, index) => (
                        <div
                            key={fitur.title}
                            className="card-minimal p-8 hover:border-primary-blue transition-colors group reveal-on-scroll flex flex-col"
                        ...
                        >
                            ...
                            <p className="text-dark-400 leading-relaxed text-sm mb-8">{fitur.description}</p>

                            {/* Link Button */}
                            <button
                                onClick={() => setModalType(fitur.id)}
                                className="mt-auto flex items-center gap-2 text-primary-blue text-sm font-semibold hover:text-neon-cyan transition-colors active:scale-[0.98] outline-none text-left cursor-pointer"
                            >
